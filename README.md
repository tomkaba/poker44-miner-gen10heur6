# poker44-miner-gen10heur6

Minimal release repository for model gen10heur6.

## Quick start

```bash
git clone https://github.com/tomkaba/poker44-miner-gen10heur6.git
cd poker44-miner-gen10heur6
python3 -m venv .venv
...
- Scorer is hardcoded to `gen10heur6`.
