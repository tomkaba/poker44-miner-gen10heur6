...
MANIFEST_REPO_URL="${POKER44_MODEL_REPO_URL:-https://github.com/tomkaba/poker44-miner-gen10heur6}"
...
for raw_id in $(echo "$IDS_STRING" | tr ',' '\n'); do
  ...
  screen -dmS "$SESSION" /bin/bash -c "
    ...
    export POKER44_SINGLE_HAND_MODEL_ALIAS=gen10heur6
    export POKER44_CHUNK_SCORER=gen10heur6
    ...
    echo '[runtime] CHUNK_SCORER=gen10heur6'
